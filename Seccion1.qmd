...
ciudades <- read_delim("C:/R-Proyectos/alerta1_cx_2026-1/data/ciudades.csv", delim = ";", locale = locale(encoding = "Latin1"))
...
::: {.callout-note title="Descripción para todos los campus"}
En las tres áreas evaluadas se evidencia una **concentración en niveles medios de dificultad**, lo que indica que, aunque los estudiantes logran desempeños funcionales, aún existen retos importantes en el desarrollo de competencias clave. **Matemáticas** presenta el mayor peso en nivel medio (52.9%), pero también un porcentaje relevante en nivel alto (26.3%), lo que señala una base aceptable con brechas importantes en razonamiento y resolución de problemas. En **Expresión Oral**, aunque predomina el nivel medio (43.3%), se observa una proporción considerable en nivel alto (32.1%), evidenciando dificultades persistentes en la comunicación efectiva. **Comprensión Lectora** se posiciona como el área más crítica, con el mayor porcentaje en nivel alto (44.6%), lo que refleja debilidades en lectura crítica, análisis e interpretación de textos.
:::
...
::: {.callout-note title="Descripción para todos los campus"}
Los resultados evidencian que las principales dificultades cognitivas se concentran en **análisis (37.6%)**, **atención (37.3%)**, **memoria (37%)** y **comprensión (36.4%)**, donde cerca de **4 de cada 10 estudiantes** reportan experimentar estas dificultades con alta frecuencia.

Estas capacidades están directamente asociadas con procesos clave del aprendizaje, como la **interpretación de información, la concentración sostenida y la retención de contenidos**, lo que sugiere un impacto potencial en el desempeño académico. En contraste, la **adaptación (29.6%)** presenta una menor incidencia, aunque sigue siendo relevante, indicando que cerca de **3 de cada 10 estudiantes** enfrentan dificultades para ajustarse a nuevas dinámicas académicas.
:::
...
::: {.callout-note title="Descripción para todos los campus"}
En el manejo de un segundo idioma solo el 18% de los estudiantes reporta dominar alguna lengua extranjera, frente a un 80% que no lo hace.
:::
