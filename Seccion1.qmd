...
plot_ly(
  ...
  layout(
    title = list(text = "<b>Distribución Porcentual de Edad por Campus (16 a 50 años)</b>", x = 0.5),
...
::: {.callout-note title="Descripción para todos los campus"}
En el área de **Matemáticas**, más de la mitad de los estudiantes (52.9%) manifestó tener un nivel medio de dificultad, mientras que el 26.3% indicó un nivel alto. Esto refleja que, aunque la mayoría percibe un manejo aceptable, aún persiste un grupo considerable con retos significativos.
En **Expresión Oral**, predomina también el nivel medio (43.3%), seguido por el nivel alto (32.1%), lo que evidencia que muchos estudiantes enfrentan dificultades para comunicarse verbalmente.
Por su parte, la **Comprensión Lectora** destaca como la competencia con mayor porcentaje en nivel alto (44.6%), lo que sugiere que la lectura crítica y el análisis de textos son las áreas más exigentes para la población estudiantil.
:::
